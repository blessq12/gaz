...
class CompanySeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('companies')->insert([
            [
                'name' => 'ООО СК "ГЕФЕСТ"',
                'desc' => 'Услуги по газификации и газоснабжению в Томске и Томской области. Подключение газа к частным домам и промышленным сооружениям. Поможем провести газ в дом под ключ по отличной цене',
                'tel' => '+7 (913) 853-03-90',
